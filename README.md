...
This repository has four main directories. run_workflow.sh will run the full workflow front to end.
...
* /src
  * the source code of this project (contains a separate readme for each of the steps in the workflow)

## Requirements

Required packages to run this code are:

* General: Bio (Bio.PDB and Bio.SeqUtils, Bio.SeqIO), pandas, scipy, numpy, matplotlib, contextlib
* MolPatch: mayavi, networkx
* Modeling: sklearn, pickle, yaml, xgboost, glob, functools
* Enrichment and expression: seaborn
